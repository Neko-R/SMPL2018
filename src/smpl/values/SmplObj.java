...
public class SmplObj {
    ...
    public enum Type {
        ...
        CHAR("Char"), STRING("String"), PAIR("Pair"), LIST("List"), TUPLE("Tuple"), PROC("Proc");
...
//    }
    ...
    public SmplObj expt(SmplObj arg) throws SmplException {
        ...
        /* Cannot exponent the default object, so throw an exception */
        throw new SmplTypeException(this, "^");
    }
	...
	return SmplBool.getConst(this.equals(arg));
    }

    public SmplObj neq(SmplObj arg) throws SmplException {

        /* This is the only operation permitted on the default object */
        return (SmplBool.getConst(this.equals(arg))).neg();
    }
